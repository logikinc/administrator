    ...
    <td class="actions">
        <ul class="list-unstyled">
            @if ($actions->authorize('view', $item))
                <li>
                    <a data-scaffold-action="{{ $module }}-view" href="{{ route('scaffold.view', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
                        <i class="fa fa-eye"></i>
            ...
            @if ($actions->authorize('update', $item))
                <li>
                    <a data-scaffold-action="{{ $module }}-edit" href="{{ route('scaffold.edit', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
            ...
            @if ($actions->authorize('delete', $item))
                <li>
                    <a data-scaffold-action="{{ $module }}-delete" onclick="return confirm('{{ trans('administrator::messages.confirm_deletion') }}')" href="{{ route('scaffold.delete', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
